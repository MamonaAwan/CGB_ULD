...
from utils_gcn import (sparse_mx_to_torch_sparse_tensor, list2dict, write_meta,
...
def test_gcn_v(model, cfg, logger):
    ...
    if cfg.save_output:
        ...
        write_meta(opath_pred_labels, logger, idx2lb, inst_num=inst_num)
    ...
    if cfg.use_gcn_feat:
        ...
        ds = BasicDataset(name=name,
                          ...
                          normalize=True)
        # ds.info() #-- shows the created dataset's details
