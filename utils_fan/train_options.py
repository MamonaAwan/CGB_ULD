...
class Options():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('-o','--option', type=str, default='model', help='Use model/scratch')
        self._parser.add_argument('-f','--folder', default='.', help='Folder to save intermediate models')
        self._parser.add_argument('--bSize', default=16, help='Batch Size')
        ...
        self._parser.add_argument('--db', default='', help='db')
        self._parser.add_argument('--checkpoint', default='data/pretrained_checkpoint/pretrained_checkpoint.pth')
        self._parser.add_argument('-lf','--lr_fan', default=1e-5, type=float, metavar='PATH', help='learning rate fan')
        self._parser.add_argument('-lg','--lr_gan', default=1e-5, type=float, metavar='PATH', help='learning rate gan')
    ...
    def write_args(self):
        ...
        with open(self.args.folder + '/args_' + self.args.file[0:-8] + 'log.txt','w') as f:
